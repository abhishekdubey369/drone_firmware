...
gpsConfig_t gpsConfig = {
    ...
    serialConfig_t serialConfig = {
        .reboot_character = 'R', // Set the reboot character to 'R'
        .portConfigs = {
            { // Configuration for the second serial port
                .identifier = serialPortIdentifier_e::SERIAL_PORT_USART2,
                .functionMask = FUNCTION_GPS, // No specific function
                .msp_baudrateIndex = 0,
                .gps_baudrateIndex = 0,
