...
//int16_t debugAccADC_trims[XYZ_AXIS_COUNT];
//int16_t debugAccADC[XYZ_AXIS_COUNT];
...
void performAcclerationCalibration(rollAndPitchTrims_t *rollAndPitchTrims)
{
    ...
    if (isOnFinalAccelerationCalibrationCycle()) {
        ...
        accelerationTrims->raw[Z] = (a[Z] + (CALIBRATING_ACC_CYCLES / 2)) / CALIBRATING_ACC_CYCLES - acc_1G;*/ //Not sure why calib/2 term was added?
    	accelerationTrims->raw[X] = (a[X]) / CALIBRATING_ACC_CYCLES;
		accelerationTrims->raw[Y] = (a[Y]) / CALIBRATING_ACC_CYCLES;
		accelerationTrims->raw[Z] = (a[Z]) / CALIBRATING_ACC_CYCLES - acc_1G;

        Monitor.println("Hitler");
        Monitor.println("X ", accelerationTrims->raw[X]);
		Monitor.println("Y ", accelerationTrims->raw[Y]);
		Monitor.println("Z ", accelerationTrims->raw[Z]);


        /*debugAccADC_trims[0] = accelerationTrims->raw[X];
        debugAccADC_trims[1] = accelerationTrims->raw[Y];
        debugAccADC_trims[2] = accelerationTrims->raw[Z];*/
...
void updateAccelerationReadings(rollAndPitchTrims_t *rollAndPitchTrims)
{
    ...
    /*if(p_timer==285){
    Monitor.println("accX ", accADC[X]);
    Monitor.println("accY ", accADC[Y]);
    Monitor.println("accZ ", accADC[Z]);
    }*/
    /*debugAccADC_trims[0] = accADC[0];
	debugAccADC_trims[1] = accADC[1];
    debugAccADC_trims[2] = accADC[2];*/
    ...
    /*debugAccADC[0] = accADC[0];
    debugAccADC[1] = accADC[1];
    debugAccADC[2] = accADC[2];*/
