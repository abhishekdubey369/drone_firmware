...
static void resetPidProfile(pidProfile_t *pidProfile)
{
    ...
    pidProfile->P8[PIDPOS] = 10; // POSHOLD_P * 100; // used for position control
    pidProfile->I8[PIDPOS] = 0; // POSHOLD_I * 100;
    pidProfile->D8[PIDPOS] = 0;

    pidProfile->P8[PIDPOSR] = 60; // POSHOLD_RATE_P * 10;
    pidProfile->I8[PIDPOSR] = 30; // POSHOLD_RATE_I * 100;
    ...
    pidProfile->P8[PIDLEVEL] = 30; //90;
    pidProfile->I8[PIDLEVEL] = 10;
    pidProfile->D8[PIDLEVEL] = 100;
    pidProfile->P8[PIDMAG] = 40;
    pidProfile->P8[PIDVEL] = 90;  //120  //40	//Change log for 8.5mm motors
    pidProfile->I8[PIDVEL] = 45;  //45    //20
    pidProfile->D8[PIDVEL] = 5;  //1      //0
...
static void resetConf(void)
{
    ...
    masterConfig.looptime = 5000;	//change log, Main loop time original 3500
