...
//AdityaLakshmi
//Position Estimate
extern bool OpticFlowValidationflag;
void checkOpticflow();
void PositionEstimate(uint32_t currentTime);
bool isOpticFlowVelocityconverted();
//extern float Est_AccelXY[2];
//extern float Old_accelXY[2];

extern int16_t debugAccelvar;
extern int16_t debugAccelvar1;
extern int16_t debugAccelvar2;
extern int16_t debugAccelvar3;
