...
//    monitorSerial.print("till 4");
    if (!serialPort) {
//    	monitorSerial.print("till 5");
        return NULL;
    }

//    monitorSerial.print("till 6");
