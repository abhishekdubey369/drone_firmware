...
We provide a library for the GPS3 Click on our [LibStock](https://libstock.mikroe.com/projects/view/1147/gps-3-click) 
...
- ``` gps3_cmdSingle ``` - Sends provided command to the module
- ``` gps3_setHandler ``` - Handler assignation to the provied command
- ``` gps3_modulePower ``` - Turn on module
...
[LibStock](https://libstock.mikroe.com/projects/view/1147/gps-3-click) page.
