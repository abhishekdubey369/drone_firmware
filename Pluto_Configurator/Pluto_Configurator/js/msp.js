...
var MSP = {
            ...
            switch (this.state) {
                ...
                case 6:
                    ...
                    if(this.code===1){
                        ...
                        var mydata = new DataView(this.message_buffer, 0);
                        console.log('Data: ' + mydata.getUint8(0)+ mydata.getUint8(1)+ mydata.getUint8(2));   
                        console.log('CheckSum Check: ' + this.message_checksum + ' '+ data[i]);
        ...
        if (!this.unsupported) switch (code) {
            ...
            */
            ...
            case MSP_codes.MSP_API_VERSION:
                ...
                var mspVer= data.getUint8(0);
                var apiMajVer= data.getUint8(1);
                var apiMinVer= data.getUint8(2);

                console.log("#version info:" +mspVer+apiMajVer+apiMinVer);
    ...
    send_message: function (code, data, callback_sent, callback_msp) {
        ...
        if (!requestExists) {
            ...
            }, 5000); // we should be able to define timeout in the future
        }
       ...
       // if(callback_msp)
      //  console.log("MPS-Callback Set");
        
      //  console.log("MPS-Send");

        // always send messages with data payload (even when there is a message already in the queue)
        if (data || !requestExists) {
           
     //      console.log("MPS-Send1:"+bufView[5]);
//
     //      console.log(bufferOut);

            serial.send(bufferOut, function (sendInfo) {
      //          console.log("MPS-Send2");

                if (sendInfo.bytesSent == bufferOut.byteLength) {
       //             console.log("MPS-Send3");
    ...
    callbacks_cleanup: function () {
        ...
        console.log("MPS-IN CALLBACK CLEANUP");
