...
var serial = {
        ...
        chrome.sockets.tcp.create({}, function (createInfo) {
            chrome.sockets.tcp.connect(createInfo.socketId,
                '192.168.4.1', 23, function (result) {
                    ...
                    self.keepAlive();
                    self.useNaglesAlgo();
                    self.onReceiveError.addListener(errorCallback);
    ...
    useNaglesAlgo: function () {
       chrome.sockets.tcp.setNoDelay(this.connectionId, false, function (result) {
       });
    },
    ...
    onReceive: {
        ...
        addListener: function (function_reference) {
            ...
            console.log("adding read Listner, connection type: ");
            console.log(chromeType);
...
console.log("ERROR CallBack, CODE:"+result.resultCode);
