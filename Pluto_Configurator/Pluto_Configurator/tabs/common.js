...
var common = (function() {
  ...
  function createNaClModule(name, tool, path, width, height, attrs) {
    ...
    moduleEl.setAttribute('width', 200);
    moduleEl.setAttribute('height', 200);
    moduleEl.setAttribute('path', 'pnacl');
    moduleEl.setAttribute('src', 'pnacl/Release/chrome-app.nmf');
  ...
  function moduleDidLoad() {
    ...
    updateStatus('Gamepad Module Loaded');
...
/*$.map(message_event.data, function(message_event.data) { 
     return parseInt(message_event.data); 
 });
 */
...
var loadGamepadModule=function() {
  ...
  var removeGamepadModule= function() {
   if(common.naclModule == document.getElementById('nacl_module')){
